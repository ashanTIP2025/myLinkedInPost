...
post_template = "Give me {number} tweets on {topic}"
...
st.subheader("Generate Trending LinkedIn Post using Generative AI 🤖")
...
number = st.number_input("Provide an Input below 10", min_value = 1, max_value = 10, value = 1, step = 1)
